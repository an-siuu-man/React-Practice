  ...
  return (
    <nav className="navbar">
      ...
      <ul className="navbar-nav">
        ...
        <li className={ isCurrentPath('/contactus') ? "nav-item-active" : 'nav-item' }  ><Link to='/contactus'><svg className={ isCurrentPath('/contactus') ? "nav-icon-active" : 'nav-icon' } viewBox="0 0 24 24" height='24px' width='24px' xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M21.384,17.752a2.108,2.108,0,0,1-.522,3.359,7.543,7.543,0,0,1-5.476.642C10.5,20.523,3.477,13.5,2.247,8.614a7.543,7.543,0,0,1,.642-5.476,2.108,2.108,0,0,1,3.359-.522L8.333,4.7a2.094,2.094,0,0,1,.445,2.328A3.877,3.877,0,0,1,8,8.2c-2.384,2.384,5.417,10.185,7.8,7.8a3.877,3.877,0,0,1,1.173-.781,2.092,2.092,0,0,1,2.328.445ZM16,11a1,1,0,0,0,1-1V8h2a1,1,0,0,0,0-2H17V4a1,1,0,0,0-2,0V6H13a1,1,0,0,0,0,2h2v2A1,1,0,0,0,16,11Z"></path></g></svg>Contact Us</Link></li>
      </ul>
    </nav>
  );
};
